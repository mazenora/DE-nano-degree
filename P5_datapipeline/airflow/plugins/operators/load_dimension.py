...
class LoadDimensionOperator(BaseOperator):
    ...
    def execute(self, context):
         """
          Insert data into dimensional tables from staging events and song Tables.
          Using a truncate-insert method to empty target tables prior to load.
          - redshift_conn_id: redshift cluster connection
          - sql_query: SQL to be applied on Redshift
          - table: Table to truncate
          - truncate: True/False to truncate table before insert
        """
